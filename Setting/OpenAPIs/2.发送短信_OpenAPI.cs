...
namespace Setting
{
    ...
    {
        private string _baseUrl = "testsmart.9jodia.net/smart";
        private System.Net.Http.HttpClient _httpClient;
        private System.Lazy<Newtonsoft.Json.JsonSerializerSettings> _settings;

        public Send_msg(System.Net.Http.HttpClient httpClient)
        {
        ...
        public virtual System.Threading.Tasks.Task<_响应_Void> SendMsgUsingPOSTAsync(SendMsgReq req)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<_响应_Void> SendMsgUsingPOSTAsync(SendMsgReq req, System.Threading.CancellationToken cancellationToken)
        {
            if (req == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<_响应_Void>(response_, headers_, cancellationToken).ConfigureAwait(false);
