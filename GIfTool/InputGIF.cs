...
{
    public static string BackGroupColor => ConfigurationManager.AppSettings["Background"];
    public static string AbcColor => ConfigurationManager.AppSettings["Foreground"];
